...
public class OCR extends AppCompatActivity {
    Button button_capture, button_copy, button_more;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_copy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String scanned_text = edit_data.getText().toString();
    ...
    private void getTextFromImage(Bitmap bitmap){
        ...
        if (!recognizer.isOperational()){
            ...
            edit_data.setText(stringBuilder.toString());
            ...
            button_more.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    String scanned = edit_data.getText().toString();
                    Intent more = new Intent(OCR.this, More_Actions.class);
                    more.putExtra("scanned", scanned);
                    OCR.this.startActivity(more);
                }
            });
    ...
    private void copyToClipBoard(String text){
        ...
        Toast.makeText(OCR.this, "Copied to clip board", Toast.LENGTH_SHORT).show();
    }
}
